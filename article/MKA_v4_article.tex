...
\begin{figure}[ht]
  ...
  \begin{lstlisting}[basicstyle=\ttfamily\scriptsize,breaklines=false,frame=none,backgroundcolor=]
KeyServer                                             Server
    |                                                   |
    |========== Pre-Shared CAK ========================>|
    |                                                   |
    ...
    | SAK1 = KDF(CAK,sid1)                              |
    |                                                   |
    | C1 = Enc(<sid1,n1,SAK1>, KEK)                     |
    | ICV1 = MAC(<C1,sid1,n1>, ICK)                     |
    |                                                   |
    |-----------------(C1,ICV1)------------------------>|
    |                                                   |
    |                                      Verify(ICV1) |
    ...
    | SAK2 = KDF(CAK,sid2)                              |
    |                                                   |
    | C2 = Enc(<sid2,n2,SAK2>,KEK)                      |
    | ICV2 = MAC(<C2,sid2,n2>,ICK)                      |
    |                                                   |
    |-----------------(C2,ICV2)------------------------>|
    |                                                   |
    |                                      Verify(ICV2) |
    ...
    |                                      state=RekeyActive |
    |                                                   |
    |                      ACK2 = MAC(<sid2,n2>,SAK2)    |
    |<------------------- ACK2 -------------------------|
    |                                                   |
    |============= Shared Fresh SAK2 ===================|
  \end{lstlisting}
  \end{minipage}
  \caption{Simplified MKA protocol flow }
  \label{fig:mka-flow}
\end{figure}
